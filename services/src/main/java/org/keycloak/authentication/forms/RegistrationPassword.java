...
public class RegistrationPassword implements FormAction, FormActionFactory {
	...
	private static final Logger log = Logger.getLogger(RegistrationPassword.class);
	...
	public void success(FormContext context) {
		...
		try {
			context.getSession().userCredentialManager().updateCredential(context.getRealm(), user,
